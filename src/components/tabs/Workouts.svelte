<script>
  ...
  import { calTrendHTML, streakHTML, monthHeatmapHTML, monthNavHTML, activityStatsHTML, activityTypeBreakdownHTML } from '../../lib/charts.js'
  import { workoutItem, groupWorkoutsByConflict, workoutStack } from '../../lib/renderers.js'
