...
export async function renderToday() {
  ...
  renderPanel(document.getElementById('cal-section'),
    ...
    `<div class="cal-badges">
       ...
       ${burnedToday > 0 ? `<span class="badge badge-burned">
         <span class="badge-burned-active"><span class="material-symbols-outlined" style="font-size:13px;vertical-align:middle">local_fire_department</span> ${burnedToday.toLocaleString()} burned</span>
         ${burnedTotalToday > burnedToday ? `<span class="badge-burned-total">${burnedTotalToday.toLocaleString()} total</span>` : ''}
       </span>` : ''}
     </div>`)
