...
export async function renderSettings() {
  ...
  panel.innerHTML = `
    <div class="tab-inner">
      ...
      <div class="settings-section">
        <div class="settings-section-title">Saved Meals</div>
      ...
      <div class="settings-section">
        <div class="settings-section-title">Saved Activities</div>
      ...
      <div class="settings-section">
        <div class="settings-section-title" style="display:flex;align-items:center;gap:8px">
          ${GOOGLE_HEALTH_SVG} Google Health
        </div>
        <div id="gh-disconnected-ui">
          <p class="setup-note">
            Sync Fitbit activities via the <a href="https://developers.google.com/health/get-started" target="_blank">Google Health API</a>.
        ...
        <div id="gh-connected-ui" style="display:none">
          ...
          <button id="remove-gh-btn" class="link-btn" style="margin-top:12px;color:var(--danger);display:block">Remove all synced activities</button>
        </div>
      </div>
  ...
  document.getElementById('settings-signout-btn').addEventListener('click', async () => {
    ...
    closeSheets()
    await supabase.auth.signOut()  // onAuthStateChange fires → state.currentUser = null → re-render
  })
}
